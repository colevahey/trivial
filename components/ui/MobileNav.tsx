...
export function MobileNav() {
  ...
  return (
    <>
      ...
      {/* Backdrop — no backdrop-blur to avoid compositing layer fighting with drawer z-index */}
      {open && (
        <div
      ...
      {/* Drawer — z-[60] clears the backdrop compositing layer on mobile WebKit */}
      <div
        className={`fixed top-0 left-0 h-full w-64 z-[60] bg-zinc-900 border-r border-zinc-800 flex flex-col transition-transform duration-300 sm:hidden ${
